        ...
        function errorTelefono() {
            ...
            if (numero.length > 10) {
                Swal.fire({
                    icon: "error",
                    title: "¡ERROR!",
                    text: "Excede la longitud del campo: " + numero.length + "/10",
                                        ...
                                        <div class="card" style="border-radius: 0.7rem;">
                                            ...
                                            <div class="card-body">
                                                <form name="formulario_fmt" method="POST"
                                                    ...
                                                    <div class="mb-1">
                                                        <label for="inputaPaterno" class="form-label">Apellido
                                                            Paterno</label>
                                                        <input type="text" name="apaterno"
                                                            class="form-control text-uppercase" id="inputaPaterno">
                                                    </div>
                                                    <div class="mb-1">
                                                        <label for="inputaMaterno" class="form-label">Apellido
                                                            Materno</label>
                                                        <input type="text" name="amaterno"
                                                            class="form-control text-uppercase" id="inputaMaterno">
                                                    </div>
                                                    <div class="mb-1">
                                                        <label for="inputDireccion" class="form-label">Dirección</label>
                                                        <input type="text" name="direccion"
                                                            class="form-control text-uppercase" id="inputDireccion">
                                                    </div>
                                                    <div class="mb-1">
                                                        <label for="inpuTelefono" class="form-label">Teléfono</label>
                                                        <input type="number" name="telefono" class="form-control"
                                                            id="numero" onkeyup="errorTelefono()" required
                                                            name="numeroTelefono">
